...
exports.changePassword = async (req,res)=>{
    ...
    //send mail
     try{
        const mailresponse = await mailSender(email,"Changed Password Email from Study Notion",passwordUpdated(email,verifyuser.firstName))
        console.log("Email sent successfully",mailresponse);

    }catch(err){
        console.log(`error occured while sending changedpassword verification email- ${err}`);
        throw err;
    }
