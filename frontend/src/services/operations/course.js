...
export const fetchCourseDetails = async (courseId) => {
  ...
  let result = null
  try {
    const response = await apiConnector("GET", COURSE_DETAILS_API, null,{courseId:courseId})
...
export const createSection = async ({SectionName,courseID}, token) => {
  let result = null
  // console.log("create section data", SectionName,);
  ...
  try {
    ...
    // console.log("result is thiiisss", response.data.updatecourse)
  } catch (error) {
